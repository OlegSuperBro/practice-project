...
class Post:
    ...
    def from_sql(**kwargs):
        ...
        tmp_post.max_vacations_length = list(map(lambda x: int(x), kwargs.get("max_vacations_length").replace(" ", "").split(",")))
        tmp_post.max_total_vacations = kwargs.get("max_total_vacations")
